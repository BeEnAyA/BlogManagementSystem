...
app.get('/comment/delete/:blogId/:commentId',authController.isAuthenticated,commentController.deleteComment)
app.get('/comment/edit/:blogId/:commentId',authController.isAuthenticated,commentController.renderEditComment)
app.post('/updateComment/:blogId/:commentId',authController.isAuthenticated,commentController.updateComment)
app.get('/changePassword',authController.isAuthenticated,controller.renderAccountSetting)
app.post('/changePassword',authController.isAuthenticated,controller.changePassword)
